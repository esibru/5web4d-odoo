			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: '3.2 - Ajouter un nouveau modèle', slug: 'labos/task-model' },
						{ label: '3.3 - Étendre Task', slug: 'labos/task-business' },
						{ label: '3.4 - Les droits d\'accès au modèle', slug: 'labos/task-management' },
