...
1. Ajoutez un attribut entier intitulé `effort_estimate` représentant le temps estimé en jours pour réaliser une tâche. Aucune valeur par défaut n'est attendue.
...
Ce second exercice vous permet de revoir l'implémentation des associations en associant 
...
vers les tags créés dans ce sous-module. Quel est le mot clé qui convient (`Many2One`, `One2Many`, `Many2Many`) ?
